# -*- coding: utf-8 -*-
"""DownloaderMD v1.3.0 — carga el motor 1.1 y aplica mejoras 1.3."""
...
def main():
    import argparse
    parser = argparse.ArgumentParser(prog="downloadermd", description="DownloaderMD — YouTube, redes y links directos")
